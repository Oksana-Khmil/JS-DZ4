...
{
  const sortedFriends = users.floatMap(user => user.friends).filter((friend, index, array) => array.indexOf(friend) === index).sort((friendName, secondFriendName)=>friendName.locateCompare(secondFriendName));
